...
import ProfilePictureComponent from '../../../components/dashboard-ui/ProfilePictureComponent';
    ...
    <Page activity={activity} className="t-profile-page">
      <div className="page-title">
        <span style={{ width: '100%', paddingBottom: 10 }}>
          {userType === 'transporter' ? 'Customer Details' : 'My Profile'}
        </span>
      </div>
      <ContainerLayout>
        <div className="p-col-12 p-md-2">
          <div className="drawer-profile">
            <div className="p-col-3 p-md-12 p-lg-6">
        ...
        <div className="p-col-9 p-md-6" style={{ padding: 0, margin: 0 }}>
          <ProfileHomeComponent profile={profile} />
        </div>
        {userType === 'transporter' ? null : (
          <ContainerLayout>
