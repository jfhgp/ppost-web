...
export const AppStoreButton = () => {
  return (
    <div>
      <a className="btn btn--ios" href="#">
        <svg
          className="btn__icon btn__icon--apple"
          version="1.1"
        ...
        <span className="btn__text">Download on the</span>
        <span className="btn__storename">App Store</span>
      </a>
    </div>
  );
};
...
export const GooglePlayStoreButton = () => {
  return (
    <div>
      <a className="btn btn--android" href="#">
        <svg
          className="btn__icon btn__icon--google"
          version="1.1"
          xmlns="http://www.w3.org/2000/svg"
          preserveAspectRatio="xMidYMid"
          viewBox="0 0 20 20"
        ...
        <span className="btn__text">Get it on</span>
        <span className="btn__storename">Google Play</span>
      </a>
    </div>
  );
};
